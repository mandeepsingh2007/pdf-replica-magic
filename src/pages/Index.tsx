    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20 lg:pt-32">
        ...
        <section id="meet-us" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8 lg:mb-16">
          <div className="border-2 lg:border-4 border-primary">
            ...
            <div className="p-4 lg:p-8 bg-white flex flex-col lg:flex-row gap-4 lg:gap-8">
              <div className="flex-1 space-y-3 lg:space-y-4 text-foreground text-sm lg:text-base">
                <p>
              ...
              <div className="flex flex-col justify-center items-center text-2xl lg:text-4xl font-bold text-foreground leading-tight">
                <img
        ...
        <section id="cover-design" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8 lg:mb-16">
          <div className="border-2 lg:border-4 border-primary">
            <div className="bg-primary text-primary-foreground py-6 lg:py-8 px-4 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-12">
              ...
              <div className="w-full lg:w-1/2 flex items-center justify-center order-1 lg:order-2">
                <img
                  ...
                  style={{ 
                    ...
                    ...window.innerWidth >= 1024 && { transform: 'scale(2.5) translateX(-130px)' }
                  }}
                />
              </div>
            </div>
          ...
          <div className="border-2 lg:border-4 border-primary">
            <div className="bg-primary text-primary-foreground py-6 lg:py-8 px-4 lg:px-8 flex flex-col lg:flex-row items-center justify-between">
              ...
              <div className="flex-shrink-0 lg:ml-8 mb-6 lg:mb-0 order-1 lg:order-2">
                <img src={layoutBooks} alt="Book layout examples" className="w-64 lg:w-96 h-auto" 
                style={{
        ...
        <section id="galore" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8 lg:mb-16">
          <div className="border-2 lg:border-4 border-primary">
            <div className="bg-primary text-primary-foreground py-8 lg:py-16 px-4 lg:px-8">
              ...
              <div className="flex flex-col lg:flex-row items-center justify-center gap-4 lg:gap-8">
                <div className="w-32 h-32 lg:w-48 lg:h-48 flex items-center justify-center order-1">
                  <img 
                    ...
                    style={{
                      transform: 'scale(1.2)',
                      ...window.innerWidth >= 1024 && { transform: 'scale(1.6) translateX(-15px)' }
                    }}
                  />
                </div>
                
                <div className="flex flex-col lg:flex-row gap-4 lg:gap-8 order-3 lg:order-2">
                  <div className="bg-white text-primary rounded-lg p-4 lg:p-8 w-full lg:w-48 text-center" style={{transform : 'translateY(-130px)'}}>
                    <h3 className="text-xl lg:text-2xl font-bold mb-1 lg:mb-2">Cover</h3>
                    <h3 className="text-xl lg:text-2xl font-bold">Design</h3>
                  </div>
                  <div className="bg-white text-primary rounded-lg p-4 lg:p-8 w-full lg:w-48 text-center" style={{transform : 'translateY(-130px)'}}>
                    <h3 className="text-xl lg:text-2xl font-bold mb-1 lg:mb-2">Layout</h3>
                    <h3 className="text-xl lg:text-2xl font-bold">Design</h3>
                  </div>
                  <div className="bg-white text-primary rounded-lg p-4 lg:p-8 w-full lg:w-48 text-center" style={{transform : 'translateY(-133px)'}}>
                    <h3 className="text-xl lg:text-2xl font-bold mb-1 lg:mb-2">Illustrations</h3>
                    <h3 className="text-xl lg:text-2xl font-bold">&</h3>
                    <h3 className="text-xl lg:text-2xl font-bold">Colouring</h3>
                  </div>
                </div>
                ...
                <div className="w-32 h-32 lg:w-48 lg:h-48 flex items-center justify-center order-2 lg:order-3">
                  <img 
                    ...
                    className="w-full h-full object-contain"
                    style={{
                      transform: 'scale(1.2) translateY(251px)',
                      ...window.innerWidth >= 1024 && { transform: 'scale(1.6) translateX(20px)' }
                    }}
                  />
                </div>
              </div>
        ...
        <section id="corporate-design" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8 lg:mb-16">
          <div className="border-2 lg:border-4 border-primary">
            <div className="bg-primary text-primary-foreground py-6 lg:py-8 px-4 lg:px-8">
        ...
        <section id="reach-us" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8 lg:mb-16">
          <div className="border-2 lg:border-4 border-primary">
            ...
            <div className="p-6 lg:p-12 bg-white text-center">
              <h3 className="text-2xl lg:text-3xl font-bold text-foreground mb-3 lg:mb-4">Get In Touch</h3>
